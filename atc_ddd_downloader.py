...
def main():
    ...
    parser.add_argument("--output-dir", default="Drug & Substance Reference/atc_ddd_data", help="Directory to save the outputs (default: Drug & Substance Reference/atc_ddd_data)")
    ...
    # 4. Save atc_hierarchy.json
    json_file = os.path.join(args.output_dir, "atc_hierarchy.json")
    tree = build_json_tree(classes_data, substances_data)
