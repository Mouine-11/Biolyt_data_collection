...
"""
    ...
    p_mol.add_argument("-o", "--output-dir", default="Drug & Substance Reference/chembl_data",
    ...
    p_trg.add_argument("-o", "--output-dir", default="Drug & Substance Reference/chembl_data",
                       help="Directory to save retrieved data (default: Drug & Substance Reference/chembl_data)")
    ...
    p_act.add_argument("-o", "--output-dir", default="Drug & Substance Reference/chembl_data",
                       help="Directory to save retrieved data (default: Drug & Substance Reference/chembl_data)")
    ...
    p_db.add_argument("-o", "--output-dir", default="Drug & Substance Reference/chembl_data",
