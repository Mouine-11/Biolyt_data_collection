...
def run_downloader(args):
    ...
    csv_path = output_dir / "Clinical Trials & Pipeline Intelligence/ctri_trials.csv"
    jsonl_path = output_dir / "Clinical Trials & Pipeline Intelligence/ctri_trials.jsonl"
...
def main():
    ...
    dl_parser.add_argument("--output-dir", type=str, default="Clinical Trials & Pipeline Intelligence/ctri_trials", help="Root folder for downloaded cache (default: Clinical Trials & Pipeline Intelligence/ctri_trials)")
    ...
    pr_parser.add_argument("--html-dir", type=str, default="Clinical Trials & Pipeline Intelligence/ctri_trials/html", help="Path to local HTML folder (default: Clinical Trials & Pipeline Intelligence/ctri_trials/html)")
    pr_parser.add_argument("--output-csv", type=str, default="Clinical Trials & Pipeline Intelligence/ctri_trials/Clinical Trials & Pipeline Intelligence/ctri_trials.csv", help="Consolidated CSV file output (default: Clinical Trials & Pipeline Intelligence/ctri_trials/Clinical Trials & Pipeline Intelligence/ctri_trials.csv)")
    pr_parser.add_argument("--output-jsonl", type=str, default="Clinical Trials & Pipeline Intelligence/ctri_trials/Clinical Trials & Pipeline Intelligence/ctri_trials.jsonl", help="Consolidated JSON Lines file output (default: Clinical Trials & Pipeline Intelligence/ctri_trials/Clinical Trials & Pipeline Intelligence/ctri_trials.jsonl)")
